...
echo Copying to output/$1"_linux"/
mkdir output/$1"_linux"
cp -r common_files/* output/$1"_linux"/
rm -r output/$1"_linux"/Makefile
cp -r linux_files/* output/$1"_linux"/
rm -r output/$1"_linux"/src/2DGame/
cp -r games_src/$1/* output/$1"_linux"/src/

python create_project_files.py linux $1 output/$1"_linux"/
